...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_RDONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_RDONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option SYMLINKS 'allowlist openat(AT_FDCWD, $path, O_RDONLY) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_RDONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option SYMLINKS 'allowlist openat(fd, $path, O_RDONLY) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_WRONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_RDWR)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_RDWR)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_RDWR)' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_RDWR|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_RDWR|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_RDWR|O_CREAT)' '
    f="no-$(unique_file)" &&
    sydbox \
        -m core/sandbox/write:deny \
        -m "allowlist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'allowlist openat(-1, $abspath, O_RDWR|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_RDWR|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
        -ESYDBOX_TEST_SUCCESS=1 \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(AT_FDCWD, $path, O_RDWR|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_RDWR|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    sydbox \
        -ESYDBOX_TEST_SUCCESS=1 \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'allowlist openat(fd, $path, O_RDWR|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    sydbox \
        -m core/sandbox/write:deny \
...
test_expect_success_foreach_option 'denylist openat(-1, $abspath, O_RDONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_RDONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(AT_FDCWD, $path, O_RDONLY|O_CREAT) for symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_RDONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(fd, $path, O_RDONLY|O_CREAT) for symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(-1, $abspath, O_RDONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_RDONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_RDONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(AT_FDCWD, $path, O_RDONLY|O_CREAT|O_EXCL) for symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_RDONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_RDONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(fd, $path, O_RDONLY|O_CREAT|O_EXCL) for symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(-1, $abspath, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY) for non-existant file' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(AT_FDCWD, $path, O_WRONLY) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY)' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY) for non-existant file' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(fd, $path, O_WRONLY) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option 'denylist openat(-1, $abspath, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT) for dangling symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY|O_CREAT)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY|O_CREAT) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(fd, $path, O_WRONLY|O_CREAT) for symbolic link' '
    f="$(unique_file)" &&
    l="$(unique_link)" &&
    touch "$f" &&
    ln -sf "$f" "$l" &&
...
test_expect_success_foreach_option SYMLINKS 'denylist openat(fd, $path, O_WRONLY|O_CREAT) for dangling symbolic link' '
    f="no-$(unique_file)" &&
    l="$(unique_link)" &&
    ln -sf "$f" "$l" &&
    test_must_violate sydbox \
...
test_expect_success_foreach_option 'denylist openat(-1, $abspath, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(AT_FDCWD, $path, O_WRONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY|O_CREAT|O_EXCL)' '
    f="no-$(unique_file)" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
        -m "denylist/write+$HOME_RESOLVED/**" \
...
test_expect_success_foreach_option 'denylist openat(fd, $path, O_WRONLY|O_CREAT|O_EXCL) for existing file' '
    f="$(unique_file)" &&
    touch "$f" &&
    test_must_violate sydbox \
        -m core/sandbox/write:allow \
